...
const FanEngagementSection = () => {
  return (
    <div className="bg-gradient-to-b font-roboto w-11/12 mx-auto rounded-3xl from-[#394B5E1F] to-[#2A313D24] text-[#DACFD3] my-16 py-32 px-10">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-10">
        ...
        <div className="w-full lg:w-1/2 text-center lg:text-left">
          <h2 className="text-5xl font-semibold mb-4">Fan Engagement & NFT Exclusives</h2>
