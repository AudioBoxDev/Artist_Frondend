...
export default function Subscription() {
	...
	return (
		<>
			<div className=" text-[#ABABAB] font-roboto rounded-lg space-y-7">
				<h2 className="text-2xl  border-b border-[#151515] pb-4 font-bold">
					Subscription
				</h2>

				<div className="space-y-4">
					<div className="flex items-center justify-between  bg-[#211E2142] p-5">
						<div>
							<p>
								Current: <strong>Annual Plan</strong>
							</p>
							<p>
								Billing Date: <span>May 15, 2025</span>
							</p>
							<p>
								<span>$15.00</span> / annually
							</p>
						</div>
						<button className="bg-pink-600 hover:bg-pink-700  text-white font-medium text-sm py-2 px-5 rounded-full">
					...
					<div>
						<h3 className="text-lg font-medium">Upgrade Subscribe</h3>
